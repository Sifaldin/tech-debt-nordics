  ...
  <section id="top" className="page-top relative overflow-hidden px-6 pb-10">
    <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2">
      ...
      <div className="relative">
        ...
        <h1 className="t-hero glow mb-6 text-5xl leading-[0.95] text-white md:text-7xl xl:text-8xl">
          Tech Debt
          <br />
          Nordics
        </h1>
        <p className="mb-9 max-w-md text-base leading-relaxed text-slate-300/85 md:text-lg">
          We help companies build fast, modern, and scalable web products
          tailored to their business goals and engineered for growth.
        </p>
